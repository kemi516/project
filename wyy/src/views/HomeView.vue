<template>
  <div class="home">
    ...
    <div v-else>
      ...
      <h3><span>最新音乐</span></h3>
      <NewSong :newSong="newSong" @song-id="nsongid" :palybt="palybt" :songId="songId" />
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    nsongid(id) {
      this.$emit("song-ids", id, this.newSong);
    },
  },
  created() {
